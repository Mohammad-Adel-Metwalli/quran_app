...
class MasjedAzkarListViewItems extends StatefulWidget
{
  const MasjedAzkarListViewItems({super.key, required this.index});
  final int index;

  @override
  State<MasjedAzkarListViewItems> createState() => _MasjedAzkarListViewItemsState();
}

class _MasjedAzkarListViewItemsState extends State<MasjedAzkarListViewItems>
{
  late String zekr;
  ...
  {
    super.initState();
    zekr = AssetsData.masjedAzkar[widget.index];
    zekrReputation = AssetsData.masjedAzkarReputation[widget.index];
